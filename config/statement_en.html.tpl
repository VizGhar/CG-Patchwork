...
text-align: center;">
        <div style="margin-bottom: 6px">
            ...
            <p style="font-weight: 700; margin-bottom: 6px;">
                <b>Patch rotations and Button Earning</b>
            </p>
            Now that you can place patches on your quilt board and you understand how "time flies", you will be allowed to rotate your patches before placing them on your board. Your button budget also shrank, so you will now have to understand how to earn those shiny little buttons.
        </div>
    <!-- END -->
...
<br><br>
                ...
                <!-- BEGIN level1 -->
                In this league your goal is to cover as much of your quilt board with patches as possible.
                <!-- END -->
        ...
        <div class="statement-rules-content">
            ...
            <br/><br/>
                ...
                <div class="statement-new-league-rule">
                <!-- END -->
            You receive <const>1</const> <strong>Button</strong> per space your time token moves.
                <!-- BEGIN level2 -->
                </div>
                <!-- END -->
            <!-- END -->
        ...
        <div class="statement-rules-content">
            ...
            <!-- BEGIN level2 -->
                <div class="statement-new-league-rule">
            Some time points of the Timeline are marked with Button icon. Whenever you move onto or past
            ...
            <!-- BEGIN level3 -->
                <div class="statement-new-league-rule">
                    <!-- END -->
            Some time points of the Timeline are marked with button or Special Patch icon. Whenever you move onto or past
...
<h1>
      ...
      <span class="icon icon-rules">&nbsp;</span>
        ...
        <div class="statement-rules-content">
            ...
            <!-- BEGIN level1 -->
            In this league you will score <const>1</const> point for each space covered with you patches.<br/><br/>
            <!-- END -->
